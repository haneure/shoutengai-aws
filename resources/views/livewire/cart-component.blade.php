                            ...
                            @foreach (Cart::instance('cart')->content() as $item)
                                <li class="pr-cart-item">
                                    <div class="product-image">
                                        @if (strpos($item->model->image, 'http') !== false)
                                            <figure><img src="{{ $item->model->image }}"
                                                    alt="{{ $item->model->name }}">
                                            </figure>
                                        @else
                                            <figure><img
                                    ...
                                    <div class="quantity">
                                        ...
                                        <p class="text-center"><a href="#"
                                                wire:click.prevent="saveForLater('{{ $item->rowId }}')">Save For
                                                Later</a></p>
                                    </div>
                ...
                <div class="summary">
                    <div class="checkout-info">
                        <a class="btn btn-checkout"
                            style="background:rgb(255, 208, 0)!important; color:black!important;" href="#"
                        ...
                        @if (Session::has('coupon'))
                            <p class="summary-info"><span class="title">Discount
                                    @if (Session::get('coupon')['type'] == 'fixed')
                                        <strong>{{ Session::get('coupon')['value'] }}$</strong>
                                    @else
                                        <strong>{{ Session::get('coupon')['value'] }}%</strong>
                                    @endif
                    ...
                    <div class="checkout-info">
                        @if (!Session::has('coupon'))
                            <div style="margin-top: 10px;">
                                <label class="checkbox-field">
                                    <input class="frm-input " name="have-code" id="have-code" value="1"
                                        type="checkbox" wire:model="haveCouponCode"><span>Use
                                        coupon code</span>
                                </label>
                            </div>
                            ...
                            @endif
                        @endif
                        <a class="btn btn-checkout" href="#" wire:click.prevent="checkout"><strong>Check
                                out</strong></a>
                    ...
                    <ul class="products-cart">
                        @foreach (Cart::instance('saveforlater')->content() as $item)
                            <li class="pr-cart-item">
                                ...
                                <div class="quantity">
                                    <p class="text-center"><a href="#"
                                            wire:click.prevent="moveToCart('{{ $item->rowId }}')">Move To Cart</a>
                                    </p>
                                </div>
                                <div class="price-field sub-total">
                                    <p class="price">${{ $item->subtotal }}</p>
                    ...
                    <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5"
                        ...
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="#" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                    <figure>
                                        <f{{ asset('assets/images/products/digital_04.jpg') }}" width="214"
