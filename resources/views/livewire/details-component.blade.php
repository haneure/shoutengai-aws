                                ...
                                @foreach ($images as $image)
                                    @if ($image)
                                        @if (strpos($image, 'http') !== false)
                                            <li style="display:flex !important;" data-thumb="{{ $image }}">
                                ...
                                <div class="product product-widget-style">
                                    <div class="thumbnnail">
                                        <a href="{{ route('product.details', ['slug' => $pop_product->slug]) }}"
                                            ...
                                            @if (strpos($pop_product->image, 'http') !== false)
                                                <figure><img src="{{ $pop_product->image }}" alt="
                                                    {{ $pop_product->name }}">
                                                </figure>
                                            @else
                                                <figure><img
                                                        src="{{ asset('assets/images/products') }}/{{ $pop_product->image }}"
                                                        alt="
                                                        {{ $pop_product->name }}">
                                                </figure>
                                            @endif
                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="{{ route('product.details', ['slug' => $rel_product->slug]) }}"
                                        ...
                                        @if (strpos($rel_product->image, 'http') !== false)
                                            <figure><img src="{{ $rel_product->image }}" width="214" height="214"
                                                    alt="{{ $rel_product->name }}">
                                            </figure>
                                        @else
                                            <figure><img
                                                    src="{{ asset('assets/images/products') }}/{{ $rel_product->image }}"
                                                    width="214" height="214" alt="{{ $rel_product->name }}">
                                            </figure>
                                        @endif
                                    </a>
                                ...
                                <div class="product-info">
                                    <a href="{{ route('product.details', ['slug' => $rel_product->slug]) }}"
                                        class="product-name"><span>{{ $rel_product->name }}</span></a>
                                    <div class="wrap-price"><span
                                            class="product-price">{{ $rel_product->price }}</span></div>
                                </div>
                            </div>
                        @endforeach
